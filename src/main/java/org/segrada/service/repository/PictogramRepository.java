 ...
 *
 * Pictogram Repository
 */
public interface PictogramRepository extends CRUDRepository<IPictogram>, SearchTermRepository<IPictogram> {
	/**
	 * Find entity by title
	 * @param title login name
	 * @return entity or null
	 */
	IPictogram findByTitle(String title);
}
