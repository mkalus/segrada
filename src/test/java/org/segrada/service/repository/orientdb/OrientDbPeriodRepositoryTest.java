...
public class OrientDbPeriodRepositoryTest {
	...
	public void setUp() throws Exception {
		...
		// create repository
		repository = new OrientDbPeriodRepository(db, new OrientDbTestApplicationSettings(), new Identity());
	}
	...
	public void tearDown() throws Exception {
		...
		repository.getDb().command(new OCommandSQL("truncate class Period")).execute();
